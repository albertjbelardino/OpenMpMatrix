PGMS=mmult_omp_timing matrix_times_vector hello pi mxv_omp_mpi mmult_mpi_omp mmult_mpi_omp2
...
mmult_mpi_omp2:          mmult.o mmult_mpi_omp2.o
	mpicc -o mmult_mpi_omp2 -fopenmp -O3 mmult.o mmult_mpi_omp2.o
